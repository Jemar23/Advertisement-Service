...
//        }
        ...
        if (requestedTargetingPredicates == null) {
            request.setTargetingPredicates(new ArrayList<>());
        }

        List<com.amazon.ata.advertising.service.targeting.predicate.TargetingPredicate> targetingPredicates = request.getTargetingPredicates().stream()
